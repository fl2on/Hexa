...
if __name__ == "__main__":
    ...
    async demoSummarization() {
        ...
        try {
            const shortSummary = await window.PuterAI.summarizeText(this.demoTexts.longText, 'short');
            console.log("Short Summary:", shortSummary);
            const mediumSummary = await window.PuterAI.summarizeText(this.demoTexts.longText, 'medium');
    ...
    async demoCodeConversion() {
        ...
        try {
            const jsCode = await window.PuterAI.convertCode(this.demoTexts.codeToConvert, 'python', 'javascript');
            console.log("Python → JavaScript:", jsCode);
            const pythonCode = await window.PuterAI.convertCode(this.demoTexts.codeExample, 'javascript', 'python');
    ...
    async demoTextEnhancement() {
        ...
        try {
            const formalText = await window.PuterAI.enhanceText(this.demoTexts.informalText, 'formal');
            console.log("Formal Enhancement:", formalText);
            const professionalText = await window.PuterAI.enhanceText(this.demoTexts.informalText, 'professional');
            console.log("Professional Enhancement:", professionalText);
            const creativeText = await window.PuterAI.enhanceText("The weather is nice today.", 'creative');
    ...
    async demoContentGeneration() {
        ...
        try {
            const article = await window.PuterAI.generateContent("The Future of Web Development", 'article', 'medium');
            console.log("Generated Article:", article);
            const blogPost = await window.PuterAI.generateContent("Best Practices for Remote Work", 'blog', 'short');
